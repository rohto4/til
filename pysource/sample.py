...
book = xlrd.open_workbook(r"D:\10_dev_doc\janome\text\test.xlsx")
...
# 例）C:\Users\〜\Documents\〜
# パスの前のrは省略しないでください
data_book = xlsxwriter.Workbook(r"D:\10_dev_doc\janome\text\create.xlsx")
# シート作成・変数定義
...
result_book = xlsxwriter.Workbook(r"D:\10_dev_doc\janome\text\ranking.xlsx")
